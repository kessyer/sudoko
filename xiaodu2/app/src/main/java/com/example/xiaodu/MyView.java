...
public class MyView extends View {
    ...
    protected char[] getNumber() {
        ...
        char[] myChar = numbers[number].toCharArray();//toCharArray将字符串对象中的字符转换为一个字符数组
        ...
        switch (difficulty) {
            ...
            case Game.DIFContinue:
                myChar=gameContext.getPreferences(Game.MODE_PRIVATE)
                        .getString("strContinue",String.valueOf(myChar)).toCharArray();//valueOf() 方法用于返回给定参数的原生 Number 对象值
                return myChar;
            default:
                break;
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        View numView = myInflater.inflate(R.layout.number, null);//根据LayoutInflater对象根据一个布局文件生成一个View
            ...
            numAlertDialog.setOnCancelListener(new OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialog) {
                    ...
                    if (!(String.valueOf(str).contains("0"))) {
                        ...
                        overDialog.setButton(BUTTON_POSITIVE, "再来一局", new DialogInterface.OnClickListener() {
